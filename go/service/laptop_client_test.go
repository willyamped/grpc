...
import (
	...
	"github.com/willyamped/grpc/service"
...
func TestClientCreateLaptop(t *testing.T) {
	...
	//check laptop is stored on server
...
func startTestLaptopServer(t *testing.T, store service.LaptopStore) (*service.LaptopServer, string) {
	// this store is in-memory store, hence for local testing
	laptopServer := service.NewLaptopServer(store)

	grpcServer := grpc.NewServer()
	pb.RegisterLaptopServiceServer(grpcServer, laptopServer)

	//dynamically assigned port, not based on CLI args
