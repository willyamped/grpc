...
type GPU struct {
	...
	Brang  string  `protobuf:"bytes,1,opt,name=brang,proto3" json:"brang,omitempty"`
	Name   string  `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x62, 0x72, 0x61, 0x6e, 0x67, 0x12, 0x12,
